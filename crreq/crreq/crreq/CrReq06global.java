...
public class CrReq06global extends AbstractJavaSamplerClient
{
	...
	public String buildXml(JavaSamplerContext context)
    {
    	...
    	Element elMain = req.addElement("getGlobalSettingsReq", req.returnDoc());
    ...
    public Arguments getDefaultParameters() {
        ...
        defaultParameters.addArgument("ActiveDocsXml","ActiveDocsXmlvariable");
