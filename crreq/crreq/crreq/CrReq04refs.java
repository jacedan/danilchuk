...
public class CrReq04refs extends AbstractJavaSamplerClient
{

	public String configRevision(String activeDocXml)
	{
		ServiceXml activeDoc = new ServiceXml();
		activeDoc.stringToDoc(activeDocXml);
		Document activeDocDocument=activeDoc.returnDoc();
		NodeList configRevisionNodeList = activeDocDocument.getElementsByTagName("configRevision");
		
		
		String configRevision = configRevisionNodeList.item(0).getTextContent();
	...
	public String buildXml(JavaSamplerContext context)
    {
    	...
    	Element elMain = req.addElement("getRefsReq", req.returnDoc());
    	
    	//PostGetRequests.writeFile(context.getParameter("ActiveDocsXml"), "r4d2");
    	
    	req.addElement("ifModifiedSince",configRevision(context.getParameter("ActiveDocsXml")),elMain);
    ...
    public Arguments getDefaultParameters() {
        ...
        defaultParameters.addArgument("URLReqLine", "/offp/fiscred/config/refs");
        ...
        defaultParameters.addArgument("ActiveDocsXml","ActiveDocsXml");
