...
public class CrReq05terminal extends AbstractJavaSamplerClient
{
	...
	public String buildXml(JavaSamplerContext context)
    {
    	...
    	Element elMain = req.addElement("getTerminalReq", req.returnDoc());
    ...
    public Arguments getDefaultParameters() {
        ...
        defaultParameters.addArgument("URLReqLine", "/offp/fiscred/info/terminal");
