...
import com.example.rcmainpack.R;
...
public class MyCalendarActivity extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		backButton=(ImageButton)findViewById(R.id.imageButtonBack_c);
		backButton.setOnClickListener(backEventListener());
	...
	public class GridCellAdapter extends BaseAdapter implements OnClickListener {
		...
		private void printMonth(int mm, int yy) {
			...
			for (int i = 1; i <= daysInMonth; i++) {
				...
				if ((i == getCurrentDayOfMonth())&&(currentMonth==this.getCurrentMonth())&&(yy==this.getCurrentYear())) 
				{
		...
		private void setCurrentMonth(int currentM) {
			this.currentMonth = currentM;
		}
		
		private void setCurrentYear(int currentY) {
